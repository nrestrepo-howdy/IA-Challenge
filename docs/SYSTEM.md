...
Generated from 368 lifecycle events spanning 13:54:05-15:46:50 UTC.
...
| | Tool calls |
|---|---|
| Orchestrator (spec, contracts, review, integration) | 33 |
| Delegated to workstreams | 130 |

80% of tool calls happened inside an isolated workstream context, not in the main thread.

### Recorded failures

10 tool failures and 13 commits are in the log. Failures are kept because a run with none is a run that was not instrumented.
