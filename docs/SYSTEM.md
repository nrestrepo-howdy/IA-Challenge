...
Generated from 5154 lifecycle events spanning 13:54:05-23:22:20 UTC.
...
### Wave 4 — 2 workstreams, 17m 14s wall clock

```
a1fdf314    |########################################################| 17m 14s  81 calls
ad7ed7cc    | ###########################                            | 8m 23s  33 calls
            +--------------------------------------------------------+
             20:47:39                                        21:04:53
```

All 2 were simultaneously live for **8m 23s**. Serial execution would have taken 25m 37s; it took 17m 14s, a **1.49x** speedup.

### Wave 5 — 2 workstreams, 17m 02s wall clock

```
a05e52cf    |########################################################| 17m 02s  91 calls
ab1aaf4f    | ####################################################   | 16m 01s  71 calls
            +--------------------------------------------------------+
             13:43:54                                        14:00:56
```

All 2 were simultaneously live for **16m 01s**. Serial execution would have taken 33m 03s; it took 17m 02s, a **1.94x** speedup.

### Wave 6 — 1 workstreams, 16m 40s wall clock

```
a6d541f9    |########################################################| 16m 40s  60 calls
            +--------------------------------------------------------+
             19:20:44                                        19:37:24
```

All 1 were simultaneously live for **16m 40s**. Serial execution would have taken 16m 40s; it took 16m 40s, a **1.00x** speedup.

### Wave 7 — 1 workstreams, 28m 22s wall clock

```
a2802dc3    |########################################################| 28m 22s  128 calls
            +--------------------------------------------------------+
             13:26:21                                        13:54:43
```

All 1 were simultaneously live for **28m 22s**. Serial execution would have taken 28m 22s; it took 28m 22s, a **1.00x** speedup.

### Division of work

| | Tool calls |
|---|---|
| Orchestrator (spec, contracts, review, integration) | 1273 |
| Delegated to workstreams | 1146 |

47% of tool calls happened inside an isolated workstream context, not in the main thread.

### Recorded failures

74 tool failures and 97 commits are in the log. Failures are kept because a run with none is a run that was not instrumented.
...
re-run to fill in a date is not measuring elapsed time any more.
