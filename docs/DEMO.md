...
| 2:20 | Terminal: `npm run verify`. Let it run. 439 tests, 26 browser, 22/22. | "The same harness that gates the agent gates every commit, and the deploy. There is no separate CI." |
